...
// Use stake.us (works from Canada/US without geo-restrictions on gameplay)
const BASE_URL = 'https://stake.us';
...
async function playGame(gameName, betAmount, state) {
  ...
  try { execSync('taskkill /F /IM chrome.exe 2>nul', { stdio: 'pipe' }); } catch (e) {}
  await sleep(2000);
